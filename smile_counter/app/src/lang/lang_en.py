...
TIME_TO_START_COUNTING_TOOLTIP = "Time in seconds that smile must be held before being counted"
FACE_SCALE_FACTOR_TOOLTIP = "Scale factor for face detection - larger values may detect smaller faces but increase false positives"